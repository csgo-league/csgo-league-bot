...
BASE_URL = 'https://raw.githubusercontent.com/csgo-league/csgo-league-bot/develop/assets/maps/images/'
...
class MapDraftCog(commands.Cog):
    ...
    async def mdraft(self, ctx):
        ...
        embed = self.bot.embed_template(title='Map draft has begun!', description=self.maps_left_str(ctx.guild))
